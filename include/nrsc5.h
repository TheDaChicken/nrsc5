...
enum
{
    ...
    NRSC5_PKT_FLAGS_HALF_FRONT = 1 << 1, /** Received ONLY the first part of the packet **/
    NRSC5_PKT_FLAGS_HALF_BACK  = 1 << 2, /** Received ONLY the last part of the packet **/
    NRSC5_PKT_FLAGS_HALF_PKT = NRSC5_PKT_FLAGS_HALF_FRONT | NRSC5_PKT_FLAGS_HALF_BACK, /** An incomplete packet. */
};
